  ...
  return (
    < div  style={{
      ...
      <CDBContainer style={{width:'100%', }}>
        <CDBCard style={{ width: '30rem',marginLeft:'30%',boxShadow: 'rgba(0, 0, 0, 0.50) 0px 54px 55px, rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px' }}>
          <CDBCardBody className="mx-4" style={{}}>
            <div className="text-center mt-4 mb-2">
              ...
              <p className="h4 font-weight-bold"> Registration Compleated!!!! </p>
              <p className="h4 font-weight-bold"> Restaurant ID!! </p>
            </div>
          ...
          <CopyToClipboard text={id} onCopy={()=>setCopied(true)}>
            ...
            <CDBBtn color="primary" style={{ width: '60%' }} className="btn-block mt-4 mx-auto"  >
              <a href='/restaurentlogin'>Login </a>
            </CDBBtn>
